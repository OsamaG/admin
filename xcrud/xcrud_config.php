...
{
    // default connection
    public static $dbname = 'intel_app'; // Your database name
    ...
    public static $language = 'ar'; // sets default localization
    public static $is_rtl = true; // enables right-to-left (RTL) mode
